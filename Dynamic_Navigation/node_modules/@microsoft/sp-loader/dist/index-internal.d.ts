...
/* Excluded from this release type: _IAssemblyComponent */

/* Excluded from this release type: _IDebugData */

/* Excluded from this release type: _IErrorInformation */

/* Excluded from this release type: _IframeLoadRedirector */
...
declare class OldManifestStoreShim {
    ...
    constructor(serviceScope: ServiceScope, webAbsoluteUrl: string, buildNumber: string);
