 ...
 */
async function writePackageAsync(terminal, solution, config) {
    ...
    await writeFileAsync(terminal, config.paths.zippedPackage, zipFile, 'binary');
}
 ...
 */
async function writeFileAsync(terminal, filename, contents, encoding) {
