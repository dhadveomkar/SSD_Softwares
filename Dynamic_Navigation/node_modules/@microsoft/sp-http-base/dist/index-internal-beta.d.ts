...
import type { IDisposable } from '@microsoft/sp-core-library';
...
export declare class AadHttpClient {
    ...
    /* Excluded from this release type: _aadTokenProvider */
 ...
 * @public
 */
export declare class AadHttpClientResponse extends HttpClientResponse {
    /* Excluded from this release type: _tokenFetchRequestTime */
    constructor(response: Response, tokenFetchRequestTime: number);
}
 ...
 * @sealed
 */
export declare class AadTokenProvider implements IInternalAadTokenProvider {
    /* Excluded from this release type: _tokenAcquisitionEventId */
    /* Excluded from this release type: _onBeforeRedirectEventId */
    /* Excluded from this release type: _popupEventId */
    /**
     * Notifies the developer before a full page redirect occurs.
     * @eventproperty
     */
    readonly onBeforeRedirectEvent: SPEvent<BeforeRedirectEventArgs>;
    /* Excluded from this release type: popupEvent */
    /* Excluded from this release type: _oboFirstPartyTokenCallback */
    /* Excluded from this release type: _oboThirdPartyTokenCallback */
    ...
    /* Excluded from this release type: _getTokenData */
    _getTokenData(resourceEndpoint: string, useCachedToken?: boolean): Promise<_ITokenData>;
    /**
    ...
    private _getDeferredAadTokenProvider;
}
...
/* Excluded from this release type: _CacheDataProviderService */

/* Excluded from this release type: _CacheKeyType */
...
/* Excluded from this release type: _fetchProviderServiceKey */

/* Excluded from this release type: _getCacheDataProviderServiceKey */

/* Excluded from this release type: _getPrefetchDataProviderServiceKey */
...
/* Excluded from this release type: _HttpClientHelper */
...
export declare interface IAadTokenProviderConfiguration {
     ...
     */
    aadUserId?: string;
    /* Excluded from this release type: spRequestGuid */
    /**
...
/* Excluded from this release type: _IAsyncPrefetchData */

/**
 * Represents arguments used before redirecting event.
 * @public
 */
export declare interface IBeforeRedirectEventArgs extends SPEventArgs {
    /**
     * The url of the page to redirect to if automatic redirect is cancelled
     */
    redirectUrl: string;
...
/* Excluded from this release type: _ICacheData */

/* Excluded from this release type: _ICacheDataProvider */

/* Excluded from this release type: _ICacheDataStat */

/* Excluded from this release type: _ICacheKey */
...
/* Excluded from this release type: IGetTokenDataOptions */

/**
 * Options for fetching a token
 *
 * @public
 */
declare interface IGetTokenOptions {
    useCachedToken?: boolean;
    claims?: string;
}

/* Excluded from this release type: _IGetTokenOptions */
...
/* Excluded from this release type: IOAuthToken */

/* Excluded from this release type: IOAuthUtilityInteractionHandlerInfo */

/* Excluded from this release type: _IPopupEventArgs */

/* Excluded from this release type: _IPrefetchData */

/* Excluded from this release type: _IPrefetchDataProvider */

/* Excluded from this release type: _IPrefetchOptions */

/* Excluded from this release type: _IPrefetchUpdateOptions */
...
/* Excluded from this release type: _isTeamsRichClientAuthFlightEnabled */
...
/* Excluded from this release type: _ITokenData */

/* Excluded from this release type: _ITokenProvider */

/* Excluded from this release type: OAuthTokenProvider */

/* Excluded from this release type: OAuthTokenType */

/**
 * Callback to get a 3P token for the OBO exchange.
 */
declare type OBO3PTokenFunction = (appId: string, claims?: string[], refresh?: boolean) => Promise<string>;

/* Excluded from this release type: OBOTokenFunction */
...
/* Excluded from this release type: PopupEventArgs */

/* Excluded from this release type: _PrefetchDataProviderService */
...
export declare class SPHttpClient {
     ...
     */
    private get _cacheDataProvider();
    private get _logSourceId();
    /**
     * Gets the prefetch data provider
     */
    private get _prefetchDataProvider();
}
...
export declare class SPHttpClientBatch {
    ...
    private _batchResponseBody;
    private _webUrl;
    /* Excluded from this release type: __constructor */
    /* Excluded from this release type: batchedSize */
    /**
    ...
    /* Excluded from this release type: batchResponseBody */
...
/* Excluded from this release type: _SPHttpClientHelper */
 ...
 * @beta
 */
export declare enum SPHttpHeader {
    /**
