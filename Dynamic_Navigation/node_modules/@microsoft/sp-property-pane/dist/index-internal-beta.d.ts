 ...
 * @beta
 */
export declare interface IGuidSet {
    /**
     * Site ID
     */
    siteId: string;
...
export declare const ImageFit: {
     ...
     */
    readonly centerCover: 4;
    /**
     * The image will be centered horizontally and vertically within the frame and maintains its aspect ratio. It will
     * behave as ImageFit.center if the image's natural height and width is less than the Image frame's height and width,
     * but if either natural height or width are larger than the frame it will behave as ImageFit.contain.
     */
    readonly centerContain: 5;
};
 ...
 * @beta
 */
export declare type ImageFit = typeof ImageFit[keyof typeof ImageFit];
...
export declare interface IPropertyPaneConfiguration {
    ...
    /* Excluded from this release type: disableAudiencePicker */
}
 ...
 * @beta
 */
export declare interface IPropertyPaneDebounceProperty {
    /**
...
/* Excluded from this release type: _IPropertyPaneDropdownTooltipProps */
 ...
 */
export declare interface IPropertyPaneDynamicTextFieldProps {
    /**
...
/* Excluded from this release type: IPropertyPaneEventArgs */
 ...
 * @beta
 */
export declare interface IPropertyPaneIconPickerProps {
    /**
     * Callback function for when an icon is selected.
     */
    onItemChanged?: (iconName: string) => void;
    /**
     * Thumbnail metadata of the currently selected icon.
     */
    thumbnail?: IThumbnail;
    /**
     * Whether to render the icon preview with full width or the default fixed aspect ratio.
     */
    previewFullWidth?: boolean;
    /**
     * Whether to render the icon with a gray background.
     */
    previewGrayBackground?: boolean;
    /**
     * Optional CSS class name to apply to the icon preview wrapper.
     */
    thumbnailRendererWrapperClassName?: string;
    /**
     * Optional CSS class name to apply to the icon preview.
     */
    thumbnailRendererIconClassName?: string;
    /**
     * Optional name of consuming component for telemetry purposes.
     */
    callerName?: string;
    /**
     * The icon picker allows selection of Fabric MDL2 icons. This optional parameter allows the caller to override
     * this with a custom selection of icons.
     */
    customIconSet?: Map<string, JSX.Element>;
    /**
     * When invoking with a custom icon set, this is the name of the currently selected icon.
     */
 ...
 * @beta
 */
export declare interface IPropertyPaneThumbnailPickerProps {
    /**
     * Service scope.
     */
    serviceScope: ServiceScope;
    /**
     * Callback function for when an image has been selected.
     */
    onItemChanged: (url: string, guidSet: IGuidSet | undefined) => void;
    /**
     * If an asset from the current site is selected, the URL can be returned as a relative URL. This option forces
     * the URL to be returned as an absolute URL.
     */
    forceFullUrl?: boolean;
    /**
     * Thumbnail metadata of the currently selected thumbnail.
     */
    thumbnail?: IThumbnail;
    /**
     * Optional name of consuming component for telemetry purposes.
    ...
    callerName?: string;
    /**
     * For the preview image, display with full width as opposed to the default fixed ratio.
     */
    previewFullWidth?: boolean;
    /**
     * Whether to display a gray background when rendering an icon.
     */
    previewGrayBackground?: boolean;
    /**
     * Optional CSS class name to apply to the wrapper of the thumbnail preview.
     */
    thumbnailRendererWrapperClassName?: string;
    /**
     * Optional CSS class name to apply to the thumbnail preview when an icon is being rendered.
     */
    thumbnailRendererIconClassName?: string;
    /**
...
export declare interface IPropertyPaneToggleProps {
     ...
     */
    label?: string;
    /* Excluded from this release type: _label */
    /**
 ...
 * @beta
 */
export declare type IThumbnail = IThumbnailImage | IThumbnailFabricReactIcon | IThumbnailIconSizeImage;
 ...
 * @beta
 */
export declare interface IThumbnailFabricReactIcon {
    /**
     * Fabric icon type.
     */
 ...
 * @beta
 */
export declare interface IThumbnailIconSizeImage {
    /**
     * Image type.
     */
 ...
 * @beta
 */
export declare interface IThumbnailImage {
    /**
     * Image type.
     */
 ...
 * @param targetProperty - Target property the icon picker is associated to.
 * @param properties - Strongly typed IconPicker properties.
 *
 * @beta
 */
 ...
 * @param targetProperty - Target property the thumbnail picker is associated to.
 * @param properties - Strongly typed ThumbnailPicker properties.
 *
 * @beta
 */
...
export declare const ThumbnailType: {
    ...
    readonly Image: 1;
    /**
     * Name of a supported icon.
     */
    readonly FabricReactIcon: 2;
    /**
     * Link to an icon-sized image.
     */
    readonly IconSizeImage: 3;
};
 ...
 * @beta
 */
export declare type ThumbnailType = typeof ThumbnailType[keyof typeof ThumbnailType];
